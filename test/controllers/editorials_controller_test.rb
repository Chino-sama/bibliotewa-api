...
class EditorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create editorial" do
    assert_difference('Editorial.count') do
      post editorials_url, params: { editorial: { image: @editorial.image, name: @editorial.name } }, as: :json
    end
  ...
  test "should update editorial" do
    patch editorial_url(@editorial), params: { editorial: { image: @editorial.image, name: @editorial.name } }, as: :json
    assert_response 200
  end
